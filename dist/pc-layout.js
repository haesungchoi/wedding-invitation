...
function PCHeroSection({
  ...
  }, "WEDDING", /*#__PURE__*/React.createElement("br", null), "INVITATION"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 8
    }
  }, /*#__PURE__*/React.createElement("div", {
...
function PCTickerBand({
  ...
  }, "Welcome to our wedding")), items.map(i => /*#__PURE__*/React.createElement("span", {
    key: 'b' + i,
    className: "ticker-item",
    style: {
      fontSize: 12,
...
function PCTheDaySection({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    }, "삼성전자 서초사옥", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#555',
        fontSize: variant === 'pc' ? 17 : 14
      }
  ...
  }, col.label), col.body))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "두 사람의 이야기가 하나가 되는 날,", /*#__PURE__*/React.createElement("br", null), "함께 축복해 주세요"))));
}
...
function PCMemoriesSection({
  ...
  }, /*#__PURE__*/React.createElement(MemoryPost, {
    lime: lime,
    ink: ink,
    ...p
  })))), /*#__PURE__*/React.createElement("div", {
...
function WideApp({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement(PCHeroSection, {
    lime: lime,
    ink: ink,
    tweaks: tweaks,
    openSheet: openSheet,
    variant: variant,
    onOpenMemories: openMemories
  }), /*#__PURE__*/React.createElement(PCTickerBand, {
    lime: lime,
    ink: ink
