...
function MemoriesScreen({ goTo, tweaks, openSheet, backHandlerRef }) {
  ...
  const interests = [
    { id: 'int-1', label: '일상', sub: 'Daily', images: ['img/memories/repost-cafe/cafe-1.jpg', 'img/memories/repost-cafe/cafe-2.jpg'] },
    { id: 'int-2', label: '맛집', sub: 'Eats', images: ['img/memories/interest-photo/interest-eats/1.JPG', 'img/memories/interest-photo/interest-eats/2.JPG', 'img/memories/interest-photo/interest-eats/3.JPG', 'img/memories/interest-photo/interest-eats/4.JPG', 'img/memories/interest-photo/interest-eats/5.JPG'] },
    { id: 'int-3', label: '액티비티', sub: 'Activity', images: [] },
    { id: 'int-4', label: '문화', sub: 'Culture', images: [] },
    { id: 'int-5', label: '여행', sub: 'Travel', images: [] },
    { id: 'int-6', label: '사진', sub: 'Photos', images: ['img/memories/interest-photo/HSC07295.JPG'] },
  ];
...
Object.assign(window, {
  MemoriesScreen, FollowingSheet, MemoryPost, PhotoCarousel, CarouselBadge, GuestbookTab,
