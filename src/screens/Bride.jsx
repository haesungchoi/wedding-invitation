import { ContactRow } from './Groom'

export default function BrideScreen({ goTo, openSheet, tweaks }) {
  ...
  return (
    <div className="inv-screen" data-screen-label="03 Bride · 윤채원">
      ...
      <section style={{ background: '#F8F6F0', padding: '8px 24px 32px', position: 'relative' }}>
        ...
        <div className="ko-light" style={{ fontSize: 14, color: '#666', marginTop: 10 }}>윤채원 · 1999. 02. 12</div>
      ...
      {/* go to groom */}
      <section style={{ background: ink, padding: '40px 24px 28px' }}>
