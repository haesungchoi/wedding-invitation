...
export function MapSheet({ open, onClose }) {
      ...
      <div style={{ fontFamily: "'Pretendard'" }}>
        ...
        <div style={{
          ...
          <svg viewBox="0 0 320 240" style={{ width: '100%', height: '100%' }}>
            ...
            <text x="180" y="120" fill="#D4E607" fontFamily="Pretendard" fontWeight="700"
            ...
            <g transform="translate(180,90)">
              <path d="M0,-22 C-10,-22 -16,-14 -16,-6 C-16,4 0,18 0,18 C0,18 16,4 16,-6 C16,-14 10,-22 0,-22 Z"
                fill="#D4E607" stroke="#111" strokeWidth="1.4" />
              <circle r="4" fill="#111" cy="-6" />
            </g>
          </svg>
          <div style={{
            position: 'absolute', bottom: 10, left: 10,
            background: '#111', color: '#D4E607', padding: '5px 10px',
            fontFamily: "'Pretendard', sans-serif", fontSize: 10, letterSpacing: '0.18em',
...
export function RSVPSheet({ open, onClose }) {
...
export function AccountSheet({ open, onClose, side }) {
  const groom = [
  ...
  const Row = ({ a, idx, gkey }) =>
    <div style={{
      ...
      <button
        ...
        className="tap"
        style={{
          background: copied === `${gkey}-${idx}` ? '#111' : '#D4E607',
          color: copied === `${gkey}-${idx}` ? '#D4E607' : '#111',
    ...
    <Sheet open={open} onClose={onClose} title="Share · 공유하기">
      ...
      <div style={{ display: 'grid', gap: 10 }}>
        <Btn bg="#FEE500" fg="#111">
          <span>카카오톡으로 공유</span>
          <span style={{ fontFamily: "'Pretendard', sans-serif", fontSize: 11, letterSpacing: '0.1em' }}>KAKAO →</span>
        </Btn>
        <Btn bg="#03C75A" fg="#fff">
          <span>네이버 밴드로 공유</span>
          <span style={{ fontFamily: "'Pretendard', sans-serif", fontSize: 11, letterSpacing: '0.1em' }}>BAND →</span>
        </Btn>
