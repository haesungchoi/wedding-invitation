export function ContactRow({ name, role, tel, lime, ink, primary }) {
  return (
    <div style={{
...
export default function GroomScreen({ goTo, openSheet, tweaks }) {
  ...
  return (
    <div className="inv-screen" data-screen-label="02 Groom · 최해성">
      ...
      <section style={{ background: '#F8F6F0', padding: '8px 24px 32px', position: 'relative' }}>
        ...
        <div className="ko-light" style={{ fontSize: 14, color: '#666', marginTop: 10 }}>최해성 · 1996. 07. 15</div>
      ...
      <section style={{ background: ink, color: lime, padding: '40px 24px' }}>
        ...
        <div style={{ display: 'grid', gap: 22 }}>
          {[
            { k: 'WORKS AS A', v: '자동차 상품기획', s: 'Product Planner' },
      ...
      {/* go to bride */}
      <section style={{ background: lime, padding: '40px 24px 28px' }}>
