    ...
    <div className="inv-screen" data-screen-label="03 Bride · 윤채원">
      ...
      <section style={{ background: '#F8F6F0', padding: '8px 24px 32px', position: 'relative' }}>
        ...
        <div style={{
          ...
          <img src="img/couple-two.jpg" alt="bride"
      ...
      <section style={{ background: lime, padding: '40px 24px' }}>
        ...
        <div style={{ display: 'grid', gap: 22 }}>
          {[
            { k: 'PROFESSION', v: '브랜드 마케터', s: 'Brand Marketer' },
            { k: 'LOVES',      v: '새로운 길', s: 'New paths' },
            { k: 'A WORD',     v: '움직임', s: 'Motion' },
          ].map((f, i) => (
            <div key={i} style={{
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ fontFamily: "'Spoqa Han Sans Neo', sans-serif", fontSize: 10, color: ink, opacity: 0.6, marginTop: 2, letterSpacing: '0.05em' }}>{f.s}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ background: '#F8F6F0', padding: '48px 24px 32px' }}>
        ...
        <div style={{
          ...
          <div className="display" style={{ fontSize: 56, lineHeight: 0.9, color: ink }}>채원</div>
        </div>

        {/* contact rows */}
        <div className="label-en" style={{ marginBottom: 12 }}>· CONTACT</div>
        <ContactRow name="윤채원" role="신부" tel="010-9876-5432" lime={lime} ink={ink} primary />
        <ContactRow name="윤재경" role="아버지" tel="010-8765-4321" lime={lime} ink={ink} />
        <ContactRow name="공명아" role="어머니" tel="010-7654-3210" lime={lime} ink={ink} />
      </section>
      ...
      <section style={{
        ...
        <button onClick={() => goTo('groom')} className="tap"
          ...
          <div className="display" style={{
            fontSize: 64, color: lime, lineHeight: 0.88,
