      ...
      <div style={{ fontFamily: "'Pretendard'" }}>
        ...
        <div style={{
          ...
          <svg viewBox="0 0 320 240" style={{ width: '100%', height: '100%' }}>
            ...
            <text x="180" y="120" fill="#D4E607" fontFamily="Archivo" fontWeight="700"
            ...
            <g transform="translate(180,90)">
              ...
              fill="#D4E607" stroke="#111" strokeWidth="1.4" style={{ stroke: "rgb(0, 0, 0)", fill: "rgb(230, 7, 7)" }} />
        ...
        <div style={{ display: 'grid', gap: 10 }}>
          <div style={{ display: 'flex', gap: 12 }}>
            ...
            <div className="ko-reg" style={{ fontSize: 13, color: '#333', lineHeight: 1.5 }}>강남역 2호선, 신분당선 8번 출구 도보 5분
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            ...
            <div className="ko-reg" style={{ fontSize: 13, color: '#333', lineHeight: 1.5, width: "211.461px" }}>사옥 지하주차장 3시간 무료
